    ...
    @if ($user->subscribed('main'))
        ...
        @if ($user->subscription('main')->onGracePeriod())
            <div class="account-subscription-body">
                ...
                <a class="account-subscription-button btn btn-sm btn-primary" href="{{ route($lang.'::subscriptions-resume') }}">@lang('Resume your subscription to the :name plan.', ['name' => __($user->subscription('main')->plan)])</a>
            </div>
        ...
        @else
            <div class="account-subscription-body">
                ...
                <a class="account-subscription-button btn btn-sm btn-secondary" href="{{ route($lang.'::subscriptions-plans') }}">@lang('Switch your subscription to another plan.')</a>
            </div>
        @endif
    @else
        @if ($plans->count() > 0)
        <div class="account-subscription-body">
            ...
            <p><a class="account-subscription-button btn btn-sm btn-primary" href="{{ route($lang.'::subscriptions-plans') }}">@lang('I subscribe')</a></p>
        </div>
        @endif
    @endif
</div>
